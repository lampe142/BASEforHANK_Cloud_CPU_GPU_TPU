...
t = @belapsed  ss_full = call_find_steadystate(m_par);
res_Runtime["t_call_find_steadystate"] = t;

# sparse DCT representation
t = @belapsed sr_full = call_prepare_linearization(ss_full, m_par);
res_Runtime["t_call_prepare_linearization"] = t;
...
t = @belapsed lr_full = linearize_full_model(sr_full, m_par);
res_Runtime["t_linearize_full_model"] = t;
...
res_Runtime["t_model_reduction"] = t;
